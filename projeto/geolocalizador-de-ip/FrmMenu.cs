...
namespace geolocalizador_de_ip
{
    public partial class FrmMenu : Form
    {
        ...
        {
            WebClient client = new WebClient(); // Criando uma nova instância da classe WebClient, classe fque fornece métodos e propriedades para facilitar a comunicação com serviços web;
